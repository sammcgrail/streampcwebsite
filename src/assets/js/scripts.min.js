!function (e, undefined) {
  ...
  var notes = {
    "1C": new Howl({
      urls: ["../media/261-C.mp3"]
    }),
    "1Cs": new Howl({
      urls: ["../media/277-C-sharp.mp3"]
    }),
    "1D": new Howl({
      urls: ["../media/293-D.mp3"]
    }),
    "1Ds": new Howl({
      urls: ["../media/311-D-sharp.mp3"]
    }),
    "1E": new Howl({
      urls: ["../media/329-E.mp3"]
    }),
    "1F": new Howl({
      urls: ["../media/349-F.mp3"]
    }),
    "1Fs": new Howl({
      urls: ["../media/369F-sharp.mp3"]
    }),
    "1G": new Howl({
      urls: ["../media/391-G.mp3"]
    }),
    "1Gs": new Howl({
      urls: ["../media/415-G-sharp.mp3"]
    }),
    "2A": new Howl({
      urls: ["../media/440-A.mp3"]
    }),
    "2As": new Howl({
      urls: ["../media/466-A-sharp.mp3"]
    }),
    "2B": new Howl({
      urls: ["../media/495-B.mp3"]
    }),
    "2C": new Howl({
